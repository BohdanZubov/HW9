...
const calculateEngravingPrice = function (message, pricePerWord) {
  ...
  return `Гравіювання коштуе ${pricePerWord * result} $ `;
};
console.log(calculateEngravingPrice("kmlfdskmf kjpsdadsakfsd kjmfscdkmf"));

// Завдання 3
// Напиши функцію findLongestWord(string),
//  яка приймає параметром довільний рядок (в рядку будуть тільки слова і прогалини) і повертає найдовше слово в цьому рядку.
...
console.log(
  findLongestWord("KMJDFKASJDJ  JKSJDKSSJDKS9F JKSJHSJKFJHSD23 HDHDH")
);
...
console.log(
  formatString("fjsjdhfhb sjhdfjhkhbhsdkjhfbjshdfkhshdjkfhbskjdhfkh hsjdhfj")
);
...
console.log(checkForSpam("kjsdjajlkdjkaj salle SPam"));
console.log(checkForSpam("bdhbdhsdh jshdjhsjdhd khjmsjdhasjdh"));
...
//  попробуйте ще раз', при цьому результат promptзаписувати в масив чисел не потрібно, після чого знову користувачеві пропонується ввести
//   число в prompt.
...
function addlogin(alllogins,login) {
  if(!isLoginValid(login)) {
    return "слово мае бути не меньше 4 символів тф не більше 16"
  }
  if(!isLoginUnique(alllogins, login)) {
    return "таке слово вже є"
  }
...
console.log(addlogin(logins, "po"));
